...
def parse_args(MODEL_CLASSES):
    ...
    # MOE config
    parser.add_argument(
        "--num_experts", type=int, default=1, help="number of experts per worker")
    ...
    parser.add_argument(
        ...
        type=str,
        default="gshard",
        choices=["naive", "gshard", "switch", "hir"],
        help="select naive, gshard, switch, hir gate strategy.")
    
    parser.add_argument(
        "--gate_reduce_freq",
        type=int,
        default=0,
        help="Reduce every gate updates steps.")
    
    parser.add_argument(
        "--topo_file",
        type=str,
        default=None,
        help="topo bandwidth file")
